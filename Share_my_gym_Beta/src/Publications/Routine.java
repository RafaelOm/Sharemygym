...
import Controllers.update_puntuation;
/**
 *
 * @author Rafa_Ordonez
 */
public class Routine implements Publication {
    ...
    public Routine(String name,int Creator_id, int publication_id,String URL){
        this.name=name;
